...
<div class="container">
  <div class="row">
    <div class="col-md-7">
      <h3 class="">NHẬN TRỌN BỘ THÔNG TIN <span class="gradient-text"> BẢNG GIÁ YÊN BÌNH COMPLEX </span>
  ...
  <div class="row">
    ...
    <div class="col-md-5">
      <div class="contact-main">
        <ul>
          <li><img src="assets/images/dvptda.png">Đơn vị Phát triển dự án: Công ty Cổ phần Đầu tư và Xây dựng Xuân Mai (XMC)</li>
