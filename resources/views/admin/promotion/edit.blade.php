                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="" style="max-width: 600px">
                                            <label class="text-truncate-set text-truncate-set-1"><input checked type="checkbox" value="{{$val->id}}" name=""> {{$val->name}}</label>
                                        </div>
                                    </td>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                          <label>Title</label>
                          <input value="{{$data->title}}" name="title" placeholder="Tiêu đề SEO" type="text" class="form-control">
                      </div>
                  </div>
                  <div class="col-md-12">
                      <div class="form-group">
                          <label>Description</label>
                          <input value="{{$data->description}}" name="description" placeholder="Mô tả SEO" type="text" class="form-control">
                      </div>
                  </div>
                </div>
            </div>
