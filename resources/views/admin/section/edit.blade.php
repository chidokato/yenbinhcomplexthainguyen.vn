...
@csrf
@method('PUT')
<input name="cid" type="hidden" value="{{$data->category_id}}" class="form-control">
                ...
                <div class="row">
                          <div class="col-md-3">
                              <div class="form-group">
                                  <label>View</label>
                                  <input name="view" value="{{$data->category->view}}" placeholder="View" type="text" class="form-control">
                              </div>
                          </div>
                          <div class="col-md-3">
                              <div class="form-group">
                                  <label>Icon</label>
                                  <input name="icon" placeholder="Icon" value="{{$data->category->icon}}" type="text" class="form-control">
                              </div>
                          </div>
                          <div class="col-md-6">
                              <div class="form-group">
                  ...
                  <div class="card-body">
                      <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  <label>Name</label>
                                  <input name="name" value="{{$data->name}}" placeholder="Tên danh mục" type="text" class="form-control">
                              </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label>Title</label>
                                  <input name="title" value="{{$data->title}}" placeholder="Tên danh mục" type="text" class="form-control">
                              </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label>Description</label>
                                  <input name="description" value="{{$data->description}}" placeholder="Tên danh mục" type="text" class="form-control">
                              </div>
                          </div>
                      </div>
                  </div>
