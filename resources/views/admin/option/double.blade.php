                  ...
                  <div class="card-body">
                      <div class="row">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label>Title</label>
                                  <input name="title" value="{{$data->title}}" placeholder="Tiêu đề SEO" type="text" class="form-control">
                              </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label>Description</label>
                                  <input name="description" value="{{$data->description}}" placeholder="Mô tả SEO" type="text" class="form-control">
                              </div>
                          </div>
                      </div>
                  </div>
